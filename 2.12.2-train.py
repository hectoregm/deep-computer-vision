...
ap.add_argument("-s", "--start-epoch", type=int, default=0, help="epocht to restart training at")
ap.add_argument("-e", "--epochs", type=int, default=10, help="number of epochs")
ap.add_argument("-r", "--rate", type=str, default="1e-1", help="learning rate")

args = vars(ap.parse_args())
lr = float(args["rate"])
print("[INFO] Start epoch: {}".format(args["start_epoch"]))
